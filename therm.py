...
heat_size = 0
room_temp = 0
og_frame = cv2.imread("/home/pi/Scripts/therm/static/img/therm_background_redline_connect.png")
            ...
            if mh*mw < 1000:
                ...
                if flat_grid.shape[0] > 10: #no human in heat signature
                    ...
                    if heat_size < 10:
                        ...
                        if room_temp > 76:
                            correction_factor = 14.0
                        elif room_temp > 75:
                            correction_factor = 15.0
                        elif room_temp > 74:
                            correction_factor = 16.0
                        elif room_temp > 73:
                            correction_factor = 17.0
                        elif room_temp > 72:
                            correction_factor = 17.0
                        elif room_temp > 70:
                            correction_factor = 18.0
                        elif room_temp > 65:
                            correction_factor = 18.0
                        else:
                            correction_factor = 19.0
                        if len(body_temp) >= 10:
